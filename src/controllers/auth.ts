...
export const create: RequestHandler = async (req: CreateUser, res) => {
  ...
  // const otpResponse = await sendVerificationOTP(token, {
  //   name,
  //   email,
...
export const sendReVerificationToken: RequestHandler = async (req, res) => {
  ...
  // const link = "https://podify-eq7h90j2f-amritraj12s-projects.vercel.app/"
  // res.send(`Click <a href="${link}">here</a> to get the otp.`)
}
